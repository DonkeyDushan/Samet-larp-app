import type { BandDefinition, ScaleDefinition } from '../types/scale'
...
export const findBand = (scale: ScaleDefinition, value: number): BandDefinition | undefined =>
  scale.bands.find((band) => value >= band.min && value <= band.max)
